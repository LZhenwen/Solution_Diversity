...
from src.pre_data_bert import *
from src.expressions_transfer import *
from src.models_bert import *
import math
import torch
import torch.optim
...
def train_tree(input_batch, input_length, target_batch, target_length, nums_stack_batch, num_size_batch, generate_nums,
    ...
    encoder_outputs, problem_output = encoder(input_var, input_length, batch_graph, bert_input)
    # Prepare input and output variables
...
def evaluate_tree(input_batch, input_length, generate_nums, encoder, predict, generate, merge, output_lang, num_pos, batch_graph, bert_input, beam_size=5, english=False, max_length=MAX_OUTPUT_LENGTH):
    ...
    encoder_outputs, problem_output = encoder.evaluate(input_var, [input_length], batch_graph, bert_input)
